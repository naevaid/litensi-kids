...
> **✅ SUDAH ADA CONTROLLER / MIGRATION / MODEL (Lokal Sudah Dijalankan. Prod belum migrate!)**
> **Migration:** `000005_buat_tabel_kuota_av_monitor_harian` (R1) + `000006_buat_tabel_sesi_stream_av_monitor` (R2) — [KuotaAvMonitorHarian Model](file:///d:/litensi-kids/backend/app/Models/KuotaAvMonitorHarian.php) + [SesiStreamAvMonitor Model](file:///d:/litensi-kids/backend/app/Models/SesiStreamAvMonitor.php).
...
| **KUOTA UTAMA 1 KOLAM** | `paket_kuota_menit_harian: integer unsigned default 0` (0 = unlimited) | Bisa di-override via AV4 `tambah-kuota-manual` (tambah menit untuk hari ini saja). Bisa di-sync dengan `paket_langganan.av_minutes_daily` nanti jika kolom ditambahkan di paket. |
