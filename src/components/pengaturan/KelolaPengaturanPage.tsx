...
export const KelolaPengaturanPage: React.FC<KelolaPengaturanPageProps> = ({
  initialSubTab = 'langganan_saya', // DEFAULT URUTAN PERTAMA SESUAI SIDEBAR: Langganan Keluarga Saya → baru Hak Akses
  onSubTabChange,
  showToast,
}) => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 w-full text-left">
      {/* Subtab Navigation Tabs: URUTAN BARU SESUAI SIDEBAR (1=Langganan, 2=Hak Akses) — Proteksi Anak DIHAPUS */}
